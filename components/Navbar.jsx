        ...
        <li>
          <Link href="/api/auth/logout">
            <a
              aria-label="Sign in"
              title="Sign in"
              className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-red-accent-400"
            >
              Logout
            </a>
          </Link>
      ...
      <li>
        <Link href="/api/auth/login">
          <a
            aria-label="Sign in"
            title="Sign in"
            class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-red-accent-400 hover:bg-deep-red-accent-700 focus:shadow-outline focus:outline-none"
          >
            Login
          </a>
        </Link>
      ...
      <div className="relative flex items-center justify-between">
        ...
        <div className="lg:hidden">
          <button
            ...
            title="Open Menu"
            className="p-2 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline hover:bg-deep-red-50 focus:bg-deep-red-50"
              ...
              <div className="p-5 bg-white border rounded shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    >
                      <svg
                        className="w-8 text-deep-red-accent-400"
                        viewBox="0 0 24 24"
                ...
                <nav>
                  <ul className="space-y-4">
                    ...
                    <li>
                      <a
                        href="/"
                        className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-red-accent-400 hover:bg-deep-red-accent-700 focus:shadow-outline focus:outline-none"
                        aria-label="Sign up"
                        title="Sign up"
                      >
                        Sign up
